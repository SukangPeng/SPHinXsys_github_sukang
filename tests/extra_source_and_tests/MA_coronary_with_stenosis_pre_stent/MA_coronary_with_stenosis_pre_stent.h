/**
 * @file MA_coronary_with_stenosis_post_stent.h
 * @brief Header file for the SPH-based simulation of coronary blood flow post-stent implantation.
 * @details This file defines key parameters, geometry, and computational utilities for simulating
 *          post-stent hemodynamics in a coronary artery with pre-existing stenosis.
 * @author Sukang Peng
 * @date March 2025
 */
#pragma once
...
std::string vessel_fluid_path = "./input/vessel_fluid_stenosis.stl";
//----------------------------------------------------------------------
