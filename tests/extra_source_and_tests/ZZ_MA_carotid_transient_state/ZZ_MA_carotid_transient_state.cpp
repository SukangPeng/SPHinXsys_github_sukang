...
#include "ZZ_MA_carotid_transient_state.h"
#include "sphinxsys.h"
using namespace SPH;
//-----------------------------------------------------------------------------------------------------------
...
int main(int ac, char *av[])
{
   ...
   // wall_boundary.defineAdaptationRatios(1.15, 2.0);
    ...
    // Cut Position Test
     ...
     Vec3d outlet_large_flow_rate_translation = Vec3d(-2.6975, -0.4330, 21.7855) * length_scale - outlet_large_normal * 0.5 * resolution_ref;
     Rotation3d outlet_large_flow_rate_rotation = outlet_large_emitter_rotation;
     Vec3d outlet_large_flow_rate_half(0.5 * resolution_ref, 3.0 * length_scale, 3.0 * length_scale);
     ...
     Vec3d outlet_small_flow_rate_translation = Vec3d(9.0220, 0.9750, 18.6389) * length_scale - outlet_small_normal * 0.25 * resolution_ref;
     Rotation3d outlet_small_flow_rate_rotation = outlet_small_disposer_rotation;
     Vec3d outlet_small_flow_rate_half(0.25 * resolution_ref, 0.25 * length_scale, 0.25 * length_scale);
