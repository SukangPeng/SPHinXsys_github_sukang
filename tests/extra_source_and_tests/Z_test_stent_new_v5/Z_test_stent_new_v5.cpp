...
int main(int ac, char *av[])
{
    ...
    //----------------------------------------------------------------------
    RadialForce radial_force(380000.0, xAxis);
    //StartupRadialForce radial_force(100000000.0, xAxis, 0.1);
    ...
    int ite = 0.0;
    Real end_time = 0.1;
    Real output_period = end_time / 10.0;
    Real dt = 0.0;
    //----------------------------------------------------------------------
