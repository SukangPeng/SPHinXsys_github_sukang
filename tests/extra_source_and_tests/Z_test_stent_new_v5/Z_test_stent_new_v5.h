...
//----------------------------------------------------------------------
std::string stent_path = "./input/stent1.stl";
...
Vec3d domain_lower_bound(-10.0 * length_scale_stent, -2.0 * length_scale_stent, -2.0 * length_scale_stent); /**< 系统域的下边界，单位：m (米) */
Vec3d domain_upper_bound(10.0 * length_scale_stent, 2.0 * length_scale_stent, 2.0 * length_scale_stent);    /**< 系统域的上边界，单位：m (米) */
...
Real youngs_modulus_stent = 5e9;      /**< 支架的杨氏模量，单位：Pa (帕) */
