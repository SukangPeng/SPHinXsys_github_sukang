...
//----------------------------------------------------------------------
std::string vessel_wall_path = "./input/coronary_wall_mm.stl";
std::string vessel_fluid_path = "./input/coronary_fluid_mm.stl";
//----------------------------------------------------------------------
...
Real DW_inlet = 4.0 * length_scale;
...
Real DW_outlet_large = 3.5 * length_scale;
...
Real DW_outlet_middle = 3.0 * length_scale;
...
Real DW_outlet_small = 2.5 * length_scale;
...
Real c_f = 10.0 * U_f * SMAX(Real(1), DW_inlet *DW_inlet / (DW_outlet_large * DW_outlet_large + DW_outlet_middle * DW_outlet_middle + DW_outlet_small * DW_outlet_small));
