...
#include "Z_test_3d_coronary_v1.h"
#include "sphinxsys.h"
using namespace SPH;
//-----------------------------------------------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    ReduceDynamics<FlowRateCalculator> compute_outlet_middle_flow_rate(outlet_middle_emitter, A_outlet_middle, "Outlet_middle");
    ...
    //stenosis_observer_contact.getSPHBody().getBaseParticles().registerStateVariable<Real>("Pressure");
    //ObservedQuantityRecording<Real> write_stenosis_pressure("Pressure", stenosis_observer_contact);
    ...
    while (physical_time < end_time)
    {
        ...
        compute_outlet_middle_flow_rate.exec();
    ...
    {
        write_stenosis_velocity.generateDataBase(1.0e-3);
    }
    else
    {
        write_stenosis_velocity.testResult();
    }
