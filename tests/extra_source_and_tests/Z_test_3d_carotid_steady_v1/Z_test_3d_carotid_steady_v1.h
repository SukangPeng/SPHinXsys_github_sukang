...
//----------------------------------------------------------------------
std::string vessel_fluid = "./input/carotid_mm.stl";
//----------------------------------------------------------------------
...
Real dp_0 = 0.3 * length_scale;                                                           /**< Initial reference particle spacing, Unit: m */
Real BW = dp_0 * 4.0;                                                                     /**< Reference size of the emitter (boundary width), Unit: m */
Vec3d domain_lower_bound(-15.0 * length_scale, -15.0 * length_scale, -35.0 * length_scale); /**< Lower boundary of the simulation domain (bounding box), Unit: m */
Vec3d domain_upper_bound(15.0 * length_scale, 15.0 * length_scale, 35.0 * length_scale);  /**< Upper boundary of the simulation domain (bounding box), Unit: m */
...
Real A_inlet = 30.0e-6;
Vec3d inlet_half(2.0 * dp_0, 3.5 * length_scale, 3.5 * length_scale);
Vec3d inlet_cut_half(2.0 * dp_0, 5.0 * length_scale, 5.0 * length_scale);
Vec3d inlet_fix_half(2.0 * dp_0, 6.0 * length_scale, 6.0 * length_scale);
Vec3d inlet_center(-1.78289736, 3.27264885, -26.86909925);
Vec3d inlet_direction(-1.78289736, 3.27264885, -25.86909925);
Vec3d inlet_normal = computeNormalDirectional(inlet_center, inlet_direction);
Vec3d inlet_cut_translation = Vec3d(-1.78289736, 3.27264885, -26.86909925) * length_scale - inlet_normal * 2.0 * dp_0;
Vec3d inlet_buffer_translation = Vec3d(-1.78289736, 3.27264885, -26.86909925) * length_scale + inlet_normal * 2.0 * dp_0;
Vec3d inlet_delete_translation = Vec3d(-1.78289736, 3.27264885, -26.86909925) * length_scale - inlet_normal * 5.0 * dp_0;
...
Real A_outlet_large = 14.0e-6;
Vec3d outlet_large_half(2.0 * dp_0, 3.0 * length_scale, 3.0 * length_scale);
Vec3d outlet_large_cut_half(2.0 * dp_0, 4.0 * length_scale, 4.0 * length_scale);
Vec3d outlet_large_fix_half(2.0 * dp_0, 4.0 * length_scale, 4.0 * length_scale);
Vec3d outlet_large_center(-6.23725814, -3.03319895, 27.2139394);
Vec3d outlet_large_direction(-5.92103037, -3.03319895, 26.2652561);
Vec3d outlet_large_normal = computeNormalDirectional(outlet_large_center, outlet_large_direction);
Vec3d outlet_large_normal_flow = computeNormalDirectional(outlet_large_direction, outlet_large_center);
Vec3d outlet_large_cut_translation = Vec3d(-6.23725814, -3.03319895, 27.2139394) * length_scale - outlet_large_normal * 2.0 * dp_0;
Vec3d outlet_large_buffer_translation = Vec3d(-6.23725814, -3.03319895, 27.2139394) * length_scale + outlet_large_normal * 2.0 * dp_0;
Vec3d outlet_large_delete_translation = Vec3d(-6.23725814, -3.03319895, 27.2139394) * length_scale - outlet_large_normal * 5.0 * dp_0;
...
// outlet_small
Real d_outlet_small = 2.0 * length_scale;
Real A_outlet_small = 8.3e-6;
Vec3d outlet_small_half(2.0 * dp_0, 2.5 * length_scale, 2.5 * length_scale);
Vec3d outlet_small_cut_half(2.0 * dp_0, 3.0 * length_scale, 3.0 * length_scale);
Vec3d outlet_small_fix_half(2.0 * dp_0, 3.0 * length_scale, 3.0 * length_scale);
Vec3d outlet_small_center(5.70464968, -1.65338904, 24.10545992);
Vec3d outlet_small_direction(5.70464968, -1.65338904, 23.10545992);
Vec3d outlet_small_normal = computeNormalDirectional(outlet_small_center, outlet_small_direction);
Vec3d outlet_small_normal_flow = computeNormalDirectional(outlet_small_direction, outlet_small_center);
Vec3d outlet_small_cut_translation = Vec3d(5.70464968, -1.65338904, 24.10545992) * length_scale - outlet_small_normal * 2.0 * dp_0;
Vec3d outlet_small_buffer_translation = Vec3d(5.70464968, -1.65338904, 24.10545992) * length_scale + outlet_small_normal * 2.0 * dp_0;
Vec3d outlet_small_delete_translation = Vec3d(5.70464968, -1.65338904, 24.10545992) * length_scale - outlet_small_normal * 5.0 * dp_0;
Vec3d outlet_small_delete_half(5.0 * dp_0, 5.0 * length_scale, 5.0 * length_scale);
// RotationOutletSmall
    ...
    : public BaseLocalDynamicsReduce<ReduceSum<Real>, BodyPartByCell>
{
  public:
    ...
    /**
     * 归约结束后，计算体积加权平均速度 v_avg = ∑(v·Vol) / ∑Vol，
