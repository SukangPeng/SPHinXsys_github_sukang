/**
 * @file MA_coronary_stent_implantation.h
 * @brief Header file for the SPH-based simulation of coronary stent expansion.
 * @details This file contains essential parameter definitions, geometry settings, and computational utilities
 *          for vessel-stent interaction (VSI) simulations within the SPHinXsys framework.
 * @author Sukang Peng
 * @date March 2025
 */
#pragma once
