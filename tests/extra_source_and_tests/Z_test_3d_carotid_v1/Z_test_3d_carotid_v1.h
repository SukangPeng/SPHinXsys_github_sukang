...
//----------------------------------------------------------------------
Vec3d translation_vessel_fluid(0.0, 0.0, 0.0); /**< 水块的初始平移，单位：m (米) */
...
class WaterBlock : public ComplexShape
{
  public:
    ...
    {
        add<TriangleMeshShapeSTL>(vessel_fluid, translation_vessel_fluid, length_scale);
    }
};
