/**
 * @file MA_carotid_fsi_steady_state.h
 * @brief Header file for the SPH-based simulation of blood flow in a carotid model.
 * @details This file contains key parameter definitions, geometry settings, and utility functions
 *          used for vascular fluid-structure interaction (FSI) simulations within the SPHinXsys framework.
 *          The model setup includes definitions for the vessel geometry, boundary conditions,
 *          particle initialization, and fundamental computational utilities for normal and rotation calculations.
 * @author Sukang Peng
 * @date March 2025
 */
#pragma once
