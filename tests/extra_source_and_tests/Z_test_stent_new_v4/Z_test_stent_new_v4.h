...
Vec3d domain_lower_bound(-20.0 * length_scale_stent, -2.0 * length_scale_stent, -2.0 * length_scale_stent); /**< 系统域的下边界，单位：m (米) */
Vec3d domain_upper_bound(20.0 * length_scale_stent, 2.0 * length_scale_stent, 2.0 * length_scale_stent);    /**< 系统域的上边界，单位：m (米) */
