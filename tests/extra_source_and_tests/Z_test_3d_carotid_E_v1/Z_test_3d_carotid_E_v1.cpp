...
#include "Z_test_3d_carotid_E_v1.h"
#include "sphinxsys.h"
using namespace SPH;
//-----------------------------------------------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    wall_boundary.defineMaterial<NeoHookeanSolid>(rho0_s_vessel, Youngs_modulus_vessel, poisson_vessel);
     ...
     AlignedBox(xAxis, Transform(Rotation3d(outlet_large_emitter_rotation), Vec3d(outlet_large_buffer_translation)), outlet_large_half));

     BoundaryGeometryAlignedBox outlet_small_boundary(wall_boundary, "OutletSmallBoundary",
      AlignedBox(xAxis, Transform(Rotation3d(outlet_small_emitter_rotation), Vec3d(outlet_small_buffer_translation)), outlet_small_half));
     ...
     // Definition Buffer
     //----------------------------------------------------------------------
     BodyAlignedBoxByCell left_emitter(water_block, AlignedBox(xAxis, Transform(Rotation3d(inlet_emitter_rotation), Vec3d(inlet_buffer_translation)), inlet_half));
     ...
     BodyAlignedBoxByCell right_up_emitter(water_block, AlignedBox(xAxis, Transform(Rotation3d(outlet_large_emitter_rotation), Vec3d(outlet_large_buffer_translation)), outlet_large_half));
     ...
     BodyAlignedBoxByCell right_down_emitter(water_block, AlignedBox(xAxis, Transform(Rotation3d(outlet_small_emitter_rotation), Vec3d(outlet_small_buffer_translation)), outlet_small_half));
