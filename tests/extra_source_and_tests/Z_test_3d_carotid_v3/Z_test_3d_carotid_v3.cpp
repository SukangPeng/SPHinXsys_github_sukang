...
#include "Z_test_3d_carotid_v3.h"
#include "sphinxsys.h"
using namespace SPH;
//-----------------------------------------------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    wall_boundary.defineBodyLevelSetShape()->correctLevelSetSign()->cleanLevelSet(1.0);
    ...
    (!sph_system.RunParticleRelaxation() && sph_system.ReloadParticles())
     ...
     sph_system, makeShared<AlignedBoxShape>(xAxis, Transform(Rotation3d(inlet_emitter_rotation), Vec3d(inlet_cut_translation)), inlet_half_cut, "TestBodyInletCut"));
