...
#include "Z_test_3d_carotid_steady_v4.h"
#include "sphinxsys.h"
using namespace SPH;
//-----------------------------------------------------------------------------------------------------------
...
int main(int ac, char *av[])
{
   ...
   // wall_boundary.defineAdaptationRatios(1.15, 2.0);
    ...
    // Cut Position Test
     ...
     // FlowRateCalculator
     //----------------------------------------------------------------------
     Vec3d inlet_flow_rate_translation = Vec3d(1.5611, 5.8559, -30.8885) * length_scale + inlet_normal * 1.0 * dp_0;
     Rotation3d inlet_flow_rate_rotation = inlet_emitter_rotation;
     Vec3d inlet_flow_rate_half(1.0 * dp_0, 3.5 * length_scale, 3.5 * length_scale);
     ...
     Vec3d outlet_large_flow_rate_translation = Vec3d(-2.6975, -0.4330, 21.7855) * length_scale + inlet_normal * 0.5 * dp_0;
     Rotation3d outlet_large_flow_rate_rotation = outlet_large_emitter_rotation;
     Vec3d outlet_large_flow_rate_half(0.5 * dp_0, 2.4 * length_scale, 2.4 * length_scale);
     ...
     Vec3d outlet_small_flow_rate_translation = Vec3d(9.0220, 0.9750, 18.6389) * length_scale + inlet_normal * 0.5 * dp_0;
     ...
     ReduceDynamics<FlowRateCalculator> compute_inlet_flow_rate(inlet_flow_rate_box, A_inlet, "inlet");
     ReduceDynamics<FlowRateCalculator> compute_outlet_large_flow_rate(outlet_large_flow_rate_box, A_outlet_large, "outlet_large");
     ReduceDynamics<FlowRateCalculator> compute_outlet_small_flow_rate(outlet_small_flow_rate_box, A_outlet_small, "outlet_small");
     //----------------------------------------------------------------------
