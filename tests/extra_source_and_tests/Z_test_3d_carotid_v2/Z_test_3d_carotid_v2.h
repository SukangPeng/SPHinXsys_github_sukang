...
RotationResult inlet_rotation_result = RotationCalculator(inlet_normal, x_Axis);
...
Vec3d outlet_large_half = Vec3d(2.0 * dp_0, 2.4 * scaling, 2.4 * scaling);
Vec3d outlet_large_cut_half = Vec3d(2.0 * dp_0, 5.0 * scaling, 5.0 * scaling);
...
RotationResult outlet_large_rotation_result = RotationCalculator(outlet_large_normal, x_Axis);
Rotation3d outlet_large_disposer_rotation(outlet_large_rotation_result.angle, outlet_large_rotation_result.axis);
Rotation3d outlet_large_emitter_rotation(outlet_large_rotation_result.angle + Pi, outlet_large_rotation_result.axis);

// outlet2 R=1.3261, (9.0220, 0.9750, 18.6389), (-0.0399, 0.0693, 0.9972)
Real DW_out_down = 1.3261 * 2 * scaling;
Vec3d outlet_small_half = Vec3d(2.0 * dp_0, 2.0 * scaling, 2.0 * scaling);
Vec3d outlet_small_cut_half = Vec3d(2.0 * dp_0, 4.0 * scaling, 4.0 * scaling);
...
RotationResult outlet_small_rotation_result = RotationCalculator(outlet_small_normal, x_Axis);
Rotation3d outlet_small_disposer_rotation(outlet_small_rotation_result.angle, outlet_small_rotation_result.axis);
Rotation3d outlet_small_emitter_rotation(outlet_small_rotation_result.angle + Pi, outlet_small_rotation_result.axis);
//----------------------------------------------------------------------
